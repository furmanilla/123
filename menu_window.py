...
lb_answer = QLabel('Введіть правильну вілповідь')
lb_wrong_answer1 = QLabel('Введіть першу хибну')
lb_wrong_answer2 = QLabel('Ведіть другу хибну')
lb_wrong_answer3 = QLabel('Ведіть третю хибну')
